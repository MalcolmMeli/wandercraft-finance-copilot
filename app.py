...
@st.cache_data
def charger():
    df = ctrl.charger_donnees("wandercraft_finance_v2.csv.gz")
...
def charger_rapprochement():
    df = ctrl.charger_donnees("wandercraft_finance_v2.csv.gz")
    releve = rap.charger_releve("releve_bancaire_v2.csv.gz")
...
# ======================================================= CONTROLE DES FACTURES
    ...
    if len(vue) == 0:
        ...
        colonnes = ["statut_traitement", "anomalie", "id_piece", "fournisseur_ou_employe",
                    "montant_ttc", "devise", "montant_eur", "date_piece", "numero_bc"]
